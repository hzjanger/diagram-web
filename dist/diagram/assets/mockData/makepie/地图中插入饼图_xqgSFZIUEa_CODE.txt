/***********参考页面：http://gallery.echartsjs.com/editor.html?c=xHyk-hgxUQ   
会动的地图
***************/
...
setTimeout(() => {
    option.series = [...option.series,  {
      ...
      type: 'pie',
      radius: '5%',
      center: myChart.convertToPixel('geo', [126.63, 45.75]),
      data: [
      ...
      type: 'pie',
      radius: '5%',
      center: myChart.convertToPixel('geo', [109.511909, 18.252847]),
      data: [
        { value: 1048, name: 'Search Engine' },
        { value: 735, name: 'Direct' },
        { value: 580, name: 'Email' },
      ...
      type: 'pie',
      radius: '5%',
      center: myChart.convertToPixel('geo', [121.48, 31.22]),
      data: [
        { value: 1048, name: 'Search Engine' },
        { value: 735, name: 'Direct' },
        { value: 580, name: 'Email' },
