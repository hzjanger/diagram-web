...
var convertData = function(data,latitude) {
    var res = [];
    for (var i = 0; i < data.length; i++) {
        var dataItem = data[i];
        if (dataItem[0].value != 0) {
            var fromCoord = latitude;
...
var series = [];
[
    ['重庆市', flowDatas,[106.4377397, 29.52648606]],
    ['北京', flowDatas1,[106.4377397, 30.96025875]]
...
option = {
    ...
    visualMap: { //图例值控制
        ...
        calculable: true,
        show: false,
        color: ['#ff8c06', '#fc9700', '#ffde00', '#ffde00', '#00eaff'],
        textStyle: {
            color: '#1e84d9'
        },
    },
