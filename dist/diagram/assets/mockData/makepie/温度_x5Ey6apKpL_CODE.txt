var XName = [
  ...
  var data1 = [
      16.2, 16.8, 18.2, 18.4, 18.7, 18.2, 18.4, 18.6, 18, 18.2, 18.4, 18.6,
    ];
var data2 = [17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17, 17];
var img = [
    ...
    series: [
        {
                        ...
                        itemStyle: {
                            ...
                            color: {
                                ...
                                colorStops: [
                                    {
                                        offset: 0,
                                        color: 'rgba(8,241,248,0.2)', // 0% 处的颜色
                                    },
                                    {
                                        offset: 1,
                                        color: '#08f1f8', // 100% 处的颜色
                                    },
                                ],
                                globalCoord: false, // 缺省为 false
                            },
                        },
                        symbolSize: [45, 45], // 容器大小
            ...
            normal: {
                ...
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                        offset: 0,
                        color: "rgba(208,254,67,0.2)"


                    },
                    {
                        offset: 1,
                        color: "rgba(208,254,67, 0)"
                    }
                ], false),
                shadowColor: 'rgba(208,254,67, 0.5)', //阴影颜色
