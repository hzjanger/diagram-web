option = {
    tooltip: {
        ...
        formatter: function (e) {
            return e.data != undefined ? e.data.content : '';
        },
    },
    geo: [
        {
  ...
  var index = 0; //播放所在下标
        var showTip = setInterval(function() {
            ...
            myChart.dispatchAction({
                type: 'showTip',
                seriesIndex: 1,
                dataIndex: (index) % option.series[1].data.length
            });
            myChart.dispatchAction({
                type: 'highlight',
                seriesIndex: 1,
